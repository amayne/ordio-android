 ...
 *	Decode MPEG & filter
 */
int mpg123_decode_and_filter(mpg123_handle *mh, const unsigned char *inmemory, size_t inmemsize, unsigned char *outmemory, size_t outmemsize, size_t *done, float filter);
